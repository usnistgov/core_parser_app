...
from core_parser_app.tools.modules.builtin.models import PopupModule
from core_parser_app.tools.modules.diffusion.forms import ExcelUploaderForm
from core_parser_app.tools.modules.exceptions import ModuleError
from core_parser_app.tools.modules.module import AbstractModule

RESOURCES_PATH = os.path.join(MODULES_ROOT, 'diffusion', 'resources')
...
class PeriodicTableModule(PopupModule):
    ...
    def __init__(self):
        ...
        popup_content = AbstractModule.render_module(os.path.join(TEMPLATES_PATH, 'periodic_simple.html'),
                                                     {'periodic_table': periodic_table})

        PopupModule.__init__(self, popup_content=popup_content, button_label='Select Element',
...
class PeriodicTableMultipleModule(PopupModule):
    ...
    def __init__(self):
        with open(os.path.join(TEMPLATES_PATH, 'periodic.html'), 'r') as periodic_file:
            periodic_table = periodic_file.read()
        popup_content = AbstractModule.render_module(os.path.join(TEMPLATES_PATH, 'periodic_multiple.html'),
                                                     {'periodic_table': periodic_table})

        PopupModule.__init__(self, popup_content=popup_content, button_label='Select Elements',
                             styles=[os.path.join(STYLES_PATH, 'periodic.css'),
...
class PeriodicTableMultipleModuleShort(PopupModule):
    ...
    def __init__(self):
        with open(os.path.join(TEMPLATES_PATH, 'periodic.html'), 'r') as periodic_file:
            periodic_table = periodic_file.read()
        popup_content = AbstractModule.render_module(os.path.join(TEMPLATES_PATH, 'periodic_multiple_short.html'),
                                                     {'periodic_table': periodic_table})
