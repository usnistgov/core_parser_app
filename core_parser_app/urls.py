...
urlpatterns = [
    re_path(r'^data-structure-element/value', user_ajax.data_structure_element_value,
    ...
    re_path(r'^template/module/delete', common_ajax.delete_module,
            name='core_parser_app_delete_template_module'),
    re_path(r'^template/module/insert', common_ajax.insert_module,
