...
class DataFixtures(FixtureInterface):
    ...
    def generate_data_structure_element(self):
        ...
        data_structure_element_1 = DataStructureElement(
            "tag1", "value1", data_structure_element_option_1, children_1
        ).save()
        data_structure_element_2 = DataStructureElement(
            "tag2", "value2", data_structure_element_option_2, self.children_2
        ).save()
        data_structure_element_3 = DataStructureElement(
            "tag3", "value3", data_structure_element_option_2, self.children_2
        ).save()
        data_structure_element_4 = DataStructureElement(
            "tag4", "value4", data_structure_element_option_xpath, self.children_2
        ).save()
        # build a collection of data structure element
        self.data_structure_element_collection = [
            data_structure_element_child_1,
...
class DataStructureElementMultipleLevelsFixture(FixtureInterface):
    ...
    def generate_data_structure_element(self):
        ...
        self.data_structure_element_1 = DataStructureElement(
            "tag_1", "value_1", children=[self.data_structure_element_1_1]
        ).save()

        self.data_structure_element_2 = DataStructureElement("tag_2", "value_2").save()

        self.data_structure_element_root = DataStructureElement(
            "root",
            "root",
            children=[self.data_structure_element_1, self.data_structure_element_2],
        ).save()

        self.data_structure_element_test = DataStructureElement("test", "test").save()

        self.data_structure_element_root_2 = DataStructureElement(
            "root2", "root2", children=[self.data_structure_element_test]
        ).save()

        # build a collection of data structure element
        self.data_structure_element_collection = [
            self.data_structure_element_root,
